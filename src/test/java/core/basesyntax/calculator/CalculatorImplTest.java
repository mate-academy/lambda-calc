...
class CalculatorImplTest {
    ...
    void positiveAndNegativeOperandPositiveResult_OK() {
        double actual = calculator.calculate(-1.0, 2.5, '+');
        double expected = 1.5;
        assertEquals(expected, actual, "Addition result for one positive one negative operand is false!");
    }
    ...
    void positiveAndNegativeOperandNegativeResult_OK() {
        double actual = calculator.calculate(1.0, -2.5, '+');
        double expected = -1.5;
        assertEquals(actual, expected, "Addition result for one positive one negative operand is false!");
    }
    ...
    void positiveAndZeroOperands_Ok() {
        ...
        double expected = 5.5;
        assertEquals(expected, actual, "Addition result for one positive one zero operand is false!");
    }
    ...
    void minDoubleValuesAddition_OK() {
        ...
        assertEquals(expected, actual, delta, "Addition result for double min value is false!");
    }
    ...
    void maxDoubleValuesAddition_OK() {
        ...
        assertEquals(expected, actual, delta, "Addition result for double max value is false!");
    }
    ...
    void twoPositiveOperandsSubtraction_OK() {
        ...
        double expected = 2.0;
        assertEquals(expected, actual, "Subtraction result for two positive operands is false!");
    }
    ...
    void twoNegativeOperandsSubtraction_OK() {
        double actual = calculator.calculate(-1.0, -2.5, '-');
        double expected = 1.5;
        assertEquals(expected, actual, "Subtraction result for two negative operands is false!");
    }
    ...
    void positiveAndNegativeOperandSubtractionResult_OK() {
        double actual = calculator.calculate(-1.0, 2.5, '-');
        double expected = -3.5;
        assertEquals(expected, actual, "Subtraction result for one positive one negative operand is false!");
    }
    ...
    void positiveAndNegativeOperandNegativeSubtraction_OK() {
        double actual = calculator.calculate(1.0, -2.5, '-');
        double expected = 3.5;
        assertEquals(actual, expected, "Subtraction result for one positive one negative operand is false!");
    }
    ...
    void positiveAndZeroOperandsSubtraction_Ok() {
        double actual = calculator.calculate(5.5, 0, '-');
        double expected = 5.5;
        assertEquals(expected, actual, "Subtraction result for one positive one zero operand is false!");
    }
    ...
    void minDoubleValuesSubtraction_OK() {
        double actual = calculator.calculate(Double.MIN_VALUE, 1, '-');
        double expected = Double.MIN_VALUE - 1;
        assertEquals(expected, actual, delta, "Subtraction result for double min value is false!");
    }
    ...
    void maxDoubleValuesSubtraction_OK() {
        double actual = calculator.calculate(Double.MAX_VALUE, 10, '-');
        double expected = Double.MAX_VALUE - 10;
        assertEquals(expected, actual, delta, "Subtraction result for double max value is false!");
    }
    ...
    void twoPositiveOperandsMultiplication_OK() {
        ...
        double expected = 125;
        assertEquals(expected, actual, "Multiplication result for two positive operands is false!");
    }
    ...
    void twoNegativeOperandsMultiplication_OK() {
        double actual = calculator.calculate(-12.5, -10, '*');
        double expected = 125;
        assertEquals(expected, actual, "Multiplication result for two negative operands is false!");
    }
    ...
    void positiveAndNegativeOperandMultiplicationResult_OK() {
        ...
        double expected = -125;
        assertEquals(expected, actual, "Multiplication result for one positive one negative operand is false!");
    }
    ...
    void positiveAndNegativeOperandNegativeMultiplication_OK() {
        double actual = calculator.calculate(10.0, -12.5, '*');
        double expected = -125;
        assertEquals(actual, expected, "Multiplication result for one positive one negative operand is false!");
    }
    ...
    void positiveAndZeroOperandsMultiplication_Ok() {
        double actual = calculator.calculate(5.5, 0, '*');
        double expected = 0;
        assertEquals(expected, actual, "Multiplication result for one positive one zero operand is false!");
    }
    ...
    void minDoubleValuesMultiplication_OK() {
        ...
        assertEquals(expected, actual, delta, "Multiplication result for double min value is false!");
    }
    ...
    void maxDoubleValuesMultiplication_OK() {
        ...
        assertEquals(expected, actual, delta, "Multiplication result for double max value is false!");
    }
    ...
    void twoPositiveOperandsDivision_OK() {
        ...
        assertEquals(expected, actual, "Division result for two positive operands is false!");
    }
    ...
    void twoNegativeOperandsDivision_OK() {
        double actual = calculator.calculate(-12.5, -10, '/');
        double expected = 1.25;
        assertEquals(expected, actual, "Division result for two negative operands is false!");
    }
    ...
    void positiveAndNegativeOperandDivisionResult_OK() {
        ...
        double expected = -1.25;
        assertEquals(expected, actual, "Division result for one positive one negative operand is false!");
    }
    ...
    void positiveAndNegativeOperandNegativeDivision_OK() {
        ...
        double expected = -1.25;
        assertEquals(actual, expected, "Division result for one positive one negative operand is false!");
    }
    ...
    void positiveAndZeroOperandsDivisionTwo_Ok() {
        double actual = calculator.calculate(0, 6.5, '/');
        double expected = 0;
        assertEquals(expected, actual, "Division result for one positive one zero operand is false!");
    }
    ...
    void twoPositiveOperandsPower_OK() {
        ...
        assertEquals(expected, actual, "Power result for two positive operands is false!");
    }
    ...
    void twoNegativeOperandsPower_OK() {
        double actual = calculator.calculate(-12.5, -10, '^');
        double expected = Math.pow(-12.5, -10);
        assertEquals(expected, actual, "Power result for two negative operands is false!");
    }
    ...
    void positiveAndNegativeOperandPowerResult_OK() {
        double actual = calculator.calculate(-12.5, 10.0, '^');
        double expected = Math.pow(-12.5, 10);
        assertEquals(expected, actual, "Power result for one positive one negative operand is false!");
    }
    ...
    void positiveAndNegativeOperandNegativePower_OK() {
        ...
        assertEquals(actual, expected, "Power result for one positive one negative operand is false!");
    }
    ...
    void positiveOperandToZeroPower_OK() {
        ...
        double expected = 1;
        assertEquals(actual, expected, "Power result for one positive and zero operand is false!");
    }
    ...
    void negativeOperandToZeroPower_OK() {
        double actual = calculator.calculate(-12.0, 0, '^');
        double expected = 1;
        assertEquals(expected, actual, "Power result for one negative one zero operand is false!");
    }
    ...
    void zeroOperandToPositivePower_OK() {
        ...
        double expected = 0;
        assertEquals(expected, actual, "Power result for zero and positive operand is false!");
    }
    ...
    void zeroOperandToNegativePower_OK() {
        double actual = calculator.calculate(0, -80, '^');
        double expected = 0;
        assertEquals(expected, actual, "Power result for negative power and zero operand is false!");
    }
