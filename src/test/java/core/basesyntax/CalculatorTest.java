...
public class CalculatorTest {
    ...
    public void additionPositiveNumbersOk() {
        operator = '+';
        Assert.assertEquals(13.1, Calculator.calculate(firstOperand, secondOperand, operator), DELTA);
    }
    ...
    public void additionPositiveAndNegativeNumbersOk() {
        operator = '+';
        Assert.assertEquals(2.1, Calculator.calculate(-firstOperand, secondOperand, operator), DELTA);
        Assert.assertEquals(-2.1, Calculator.calculate(firstOperand, -secondOperand, operator), DELTA);
    }
    ...
    public void subtractionPositiveNumbersOk() {
        operator = '-';
        Assert.assertEquals(-2.1, Calculator.calculate(firstOperand, secondOperand, operator), DELTA);
        Assert.assertEquals(2.1, Calculator.calculate(secondOperand, firstOperand, operator), DELTA);
    }
    ...
    public void subtractionPositiveAndNegativeNumbersOk() {
        operator = '-';
        Assert.assertEquals(-13.1, Calculator.calculate(-firstOperand, secondOperand, operator), DELTA);
        Assert.assertEquals(13.1, Calculator.calculate(secondOperand, -firstOperand, operator), DELTA);
    }
    ...
    public void divisionPositiveNumbersOk() {
        operator = '/';
        Assert.assertEquals(0.723, Calculator.calculate(firstOperand, secondOperand, operator), DELTA);
    }
    ...
    public void divisionZeroNumbers() {
        operator = '/';
        Assert.assertEquals(0, Calculator.calculate(0, secondOperand, operator), DELTA);
    ...
    public void multiplicationPositiveNumbersOk() {
        operator = '*';
        Assert.assertEquals(41.8, Calculator.calculate(firstOperand, secondOperand, operator), DELTA);
    }
    ...
    public void multiplicationZeroNumbersOk() {
        operator = '*';
        Assert.assertEquals(0, Calculator.calculate(0, secondOperand, operator), DELTA);
        Assert.assertEquals(0, Calculator.calculate(-firstOperand, 0, operator), DELTA);
    }

    @Test
    public void raisingToThePowerPositiveNumbersOk() {
        operator = '^';
        Assert.assertEquals(423405.446, Calculator.calculate(firstOperand, secondOperand, operator), DELTA);
    }

    @Test
    public void raisingToThePowerNegativeNumbersOk() {
        operator = '^';
        Assert.assertEquals(NaN, Calculator.calculate(-firstOperand, secondOperand, operator), DELTA);
        Assert.assertEquals(NaN, Calculator.calculate(-firstOperand, -secondOperand, operator), DELTA);
    }
    ...
    public void raisingToTheNegativePowerOk() {
        operator = '^';
        Assert.assertEquals(0.00000236, Calculator.calculate(firstOperand, -secondOperand, operator), 0.00000001);
    }

    @Test
    public void raisingNullToThePositivePowerOk() {
        operator = '^';
        Assert.assertEquals(0, Calculator.calculate(0, secondOperand, operator), 0.00000001);
    }
    ...
    public void raisingToTheZeroPowerOk() {
        operator = '^';
        Assert.assertEquals(1, Calculator.calculate(firstOperand, 0, operator), 0.00000001);
    }
}
