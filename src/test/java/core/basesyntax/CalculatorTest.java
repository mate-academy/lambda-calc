...
public class CalculatorTest {
    ...
    @Test
    void addition_PositiveOperands_OK() {
    ...
    @Test
    void addition_NegativeOperands_OK() {
    ...
    @Test
    void addition_PositiveNegativeOperands_OK() {
    ...
    @Test
    void addition_ZeroInDifferentPlaces_OK() {
    ...
    @Test
    void addition_ForMinAndMaxDoubleValues_OK() {
    ...
    @Test
    void subtraction_PositiveOperands_OK() {
    ...
    @Test
    void subtraction_NegativeOperands_OK() {
        actual = calculator.calculate(-0.00054, -0.0003, SUBTRACTION);
        expected = -0.00024;
        assertEquals(expected, actual, DELTA);
    }
    ...
    @Test
    void subtraction_PositiveNegativeOperands_OK() {
    ...
    @Test
    void subtraction_ZeroInDifferentPlaces_OK() {
    ...
    @Test
    void subtraction_ForMinAndMaxDoubleValues_OK() {
    ...
    @Test
    void multiplication_PositiveOperands_OK() {
    ...
    @Test
    void multiplication_NegativeOperands_OK() {
        actual = calculator.calculate(-0.005, -0.003, MULTIPLICATION);
        expected = 0.000015;
        assertEquals(expected, actual, DELTA);
    }
    ...
    @Test
    void multiplication_PositiveNegativeOperands_OK() {
    ...
    @Test
    void multiplication_ForMinAndMaxDoubleValues_OK() {
    ...
    @Test
    void division_PositiveOperands_OK() {
    ...
    @Test
    void division_NegativeOperands_OK() {
    ...
    @Test
    void division_PositiveNegativeOperands_OK() {
    ...
    @Test
    void division_ZeroInDifferentPlaces_OK() {
    ...
    @Test
    void division_ForMinAndMaxDoubleValues_OK() {
    ...
    @Test
    void raising_PositiveValue_ToThePositivePower_OK() {
    ...
    @Test
    void raising_NegativeValue_ToThePositivePower_OK() {
    ...
    @Test
    void raising_PositiveValue_ToTheNegativePower_OK() {
        actual = calculator.calculate(0.07, -3, RAISING);
    ...
    @Test
    void raising_NegativeValue_ToTheNegativePower_OK() {
        actual = calculator.calculate(-0.07, -3, RAISING);
        expected = -2915.45189504;
        assertEquals(expected, actual,DELTA);
    ...
    @Test
    void raising_PositiveNegativeValue_toZeroPower_OK() {
