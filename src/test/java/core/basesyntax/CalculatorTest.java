...
class CalculatorTest {
    ...
    private static final char ADDITION = 'a';
    private static final char SUBTRACTION = 's';
    private static final char MULTIPLICATION = 'm';
    private static final char DIVISION = 'd';
    private static final char EXPONENTIATION = 'p';
    ...
    void calculate_additionTwoPositiveNumbers_isOk() {
        actual = calculator.calculate(1000.05, 100.05, ADDITION);
    ...
    void calculate_additionNegativeAndPositiveNumbers_isOk() {
        actual = calculator.calculate(0.000049, -0.00005, ADDITION);
    ...
    void calculate_additionWithZero_isOk() {
        actual = calculator.calculate(20.5555555, 0.0, ADDITION);
        assertEquals(20.5555555, actual);
        actual = calculator.calculate(0.0, -20.5555555, ADDITION);
        assertEquals(-20.5555555, actual);
    }

    @Test
    void calculate_additionMinAndMaxDoubleValue_isOk() {
        actual = calculator.calculate(Double.MIN_VALUE, 1.0, ADDITION);
        assertEquals(1.0, actual);
        actual = calculator.calculate(Double.MAX_VALUE, 1.0, ADDITION);
    ...
    void calculate_subtractionTwoPositiveNumbers_isOk() {
        actual = calculator.calculate(1000.05, 100.05, SUBTRACTION);
    ...
    void calculate_subtractionNegativeAndPositiveNumbers_isOk() {
        actual = calculator.calculate(-0.000049, 0.00005, SUBTRACTION);
    ...
    void calculate_subtractionWithZero_isOk() {
        actual = calculator.calculate(20.5555555, 0.0, SUBTRACTION);
        assertEquals(20.5555555, actual);
        actual = calculator.calculate(0.0, -20.5555555, SUBTRACTION);
        assertEquals(20.5555555, actual);
    }

    @Test
    void calculate_subtractionMinAndMaxDoubleValue_isOk() {
        actual = calculator.calculate(Double.MIN_VALUE, 1.0, SUBTRACTION);
        assertEquals(-1.0, actual);
        actual = calculator.calculate(Double.MAX_VALUE, 1.0, SUBTRACTION);
        assertEquals(Double.MAX_VALUE, actual);
    ...
    void calculate_multiplicationTwoPositiveNumbers_isOk() {
        actual = calculator.calculate(10.0, 100.0, MULTIPLICATION);
    ...
    void calculate_multiplicationNegativeAndPositiveNumbers_isOk() {
        actual = calculator.calculate(-0.1, 0.1, MULTIPLICATION);
    ...
    void calculate_multiplicationWithZero_isOk() {
        actual = calculator.calculate(20.5555555, 0.0, MULTIPLICATION);
        assertEquals(0.0, actual);
        actual = calculator.calculate(0.0, -20.5555555, MULTIPLICATION);
        assertEquals(-0.0, actual);
    }
    ...
    void calculate_multiplicationMaxDoubleValue_isOk() {
        actual = calculator.calculate(Double.MAX_VALUE, 2.0, MULTIPLICATION);
        assertEquals(Double.POSITIVE_INFINITY, actual);
        actual = calculator.calculate(Double.MAX_VALUE, 1.0, MULTIPLICATION);
        assertEquals(Double.MAX_VALUE, actual);
    }

    @Test
    void calculate_multiplicationMinDoubleValue_isOk() {
        actual = calculator.calculate(Double.MIN_VALUE, 1.0, MULTIPLICATION);
        assertEquals(Double.MIN_VALUE, actual);
        actual = calculator.calculate(Double.MIN_VALUE, 0.9, MULTIPLICATION);
        assertEquals(Double.MIN_VALUE, actual);
    }

    @Test
    void calculate_divisionTwoPositiveNumbers_isOk() {
        actual = calculator.calculate(100.0, 10.0, DIVISION);
        assertEquals(10.0, actual);
    }

    @Test
    void calculate_divisionTwoNegativeNumbers_isOk() {
        actual = calculator.calculate(-10.0, -100.0, DIVISION);
        assertEquals(0.1, actual);
    }

    @Test
    void calculate_divisionNegativeAndPositiveNumbers_isOk() {
        actual = calculator.calculate(-0.0001, 10.0, DIVISION);
    ...
    void calculate_divisionWithZero_isOk() {
        actual = calculator.calculate(0, -20.5555555, DIVISION);
        assertEquals(-0.0, actual);
    ...
    void calculate_divisionByMaxDoubleValue_isNotOk() {
        actual = calculator.calculate(1.0, Double.MAX_VALUE, DIVISION);
    ...
    void calculate_divisionByMinDoubleValue_isOk() {
        actual = calculator.calculate(1.0, Double.MIN_VALUE, DIVISION);
        assertEquals(Double.POSITIVE_INFINITY, actual);
    }

    @Test
    void calculate_raisingPositiveAndNegativeNumberToPositivePower_isOk() {
        actual = calculator.calculate(2.0, 3.0, EXPONENTIATION);
    ...
    void calculate_raisingPositiveAndNegativeNumberToZero_isOk() {
        actual = calculator.calculate(2.0, 0.0, EXPONENTIATION);
        assertTrue(actual == 1);
        actual = calculator.calculate(-2.0, 0.0, EXPONENTIATION);
        assertTrue(actual == 1);
    }
    ...
    void calculate_raisingZeroToPower_isOk() {
        ...
        actual = calculator.calculate(0.0, exponent, EXPONENTIATION);
