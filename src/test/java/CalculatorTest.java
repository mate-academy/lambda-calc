...
class CalculatorTest {
    ...
    void calculate_additionTwoPositiveOperands_Ok() {
        ...
        double actual = calcucator.calculate(40.0, 10.0, '+');
    ...
    void calculate_additionFirstZeroOperand_Ok() {
        ...
        double actual = calcucator.calculate(0, 10.0, '+');
        assertEquals(expected, actual);
    }
    ...
    void calculate_additionSecondZeroOperand_Ok() {
        ...
        double actual = calcucator.calculate(40.0, 0, '+');
        assertEquals(expected, actual);
    }
    ...
    void calculate_raisingPositiveValueToPositivePower_Ok() {
        ...
        double actual = calcucator.calculate(3.0, 3.0, '^');
        assertEquals(expected, actual);
    }
    ...
    void calculate_raisingNegativeValueToPositivePower_Ok() {
        double expected = 9.0;
        double actual = calcucator.calculate(-3.0, 2, '^');
        assertEquals(expected, actual);
    }
    ...
    void calculate_raisingPositiveValueToNegativePower_Ok() {
        double expected = 0.1;
        double actual = calcucator.calculate(10.0, -1.0, '^');
        assertEquals(expected, actual);
    }
    ...
    void calculate_raisingNegativeValueToNegativePower_Ok() {
        double expected = -1;
        double actual = calcucator.calculate(-1, -1, '^');
        assertEquals(expected, actual);
    }
    ...
    void calculate_raisingZeroValueToPower_Ok() {
        double expected = 0;
        double actual = calcucator.calculate(0.0, 1, '^');
        assertEquals(expected, actual);
    }
    ...
    void calculate_raisingPositiveValueToZeroPower_Ok() {
        double expected = 1;
        double actual = calcucator.calculate(10.0, 0.0, '^');
        assertEquals(expected, actual);
    }
    ...
    void calculate_illegalOperation_Ok() {
        ...
        assertThrows(IllegalArgumentException.class, () -> {
            calcucator.calculate(100.0, 100.0, illegalOperaion);
        });
    }
}
